<?
$localOptionsFileName = 'beeralex_catalog_options.php';
...
if(file_exists($bitrixPath . $basePathToOptions)) {
    $beeralex_catalog_default_option = include $bitrixPath . $basePathToOptions;
} elseif (file_exists($localPath . $basePathToOptions)) {
    $beeralex_catalog_default_option = include $localPath . $basePathToOptions;
}