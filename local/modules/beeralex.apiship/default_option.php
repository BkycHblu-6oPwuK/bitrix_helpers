<?
$localOptionsFileName = 'beeralex_apiship_options.php';
...
if (file_exists($bitrixPath . $basePathToOptions)) {
    $beeralex_apiship_default_option = include $bitrixPath . $basePathToOptions;
} elseif (file_exists($localPath . $basePathToOptions)) {
    $beeralex_apiship_default_option = include $localPath . $basePathToOptions;
}
