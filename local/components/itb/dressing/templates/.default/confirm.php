...
<div class="checkout-success-block">
    <div class="checkout-success-block__info">
        ...
        <span class="checkout-success-block__info-message">Номер вашего заказа #<?=$orderId?></span>
    ...
    <div class="checkout-success-block__buttons">
        <a href="<?=PageHelper::getProfileDressingsPageUrl() . $orderId?>"><button class="checkout-success-block__submit">Перейти к заказу</button></a>
