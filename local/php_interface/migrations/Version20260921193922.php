...
class Version20260921193922 extends Version
{
    protected $author = "admin";

    protected $description = "инфоблок главная, изменить привязки свойств *_IDS к элементам ИБ";
  ...
  array (
    ...
    'PROPERTY_PRODUCTS_SECTION_IDS' => 'Раздел товаров',
  ...
  array (
    ...
    'PROPERTY_ARTICLES_TYPE' => 'Тип статей',
  ),
  'Главный баннер|cedit6' => 
  array (
    'PROPERTY_71' => 'Главный баннер',
  ),
  'SEO|edit14' => 
  array (
