...
$productsIds = Products::getPopularProductsIds(0, 86400);
if (empty($productsIds)) {
	LocalRedirect(PageHelper::getCatalogPageUrl());
}
$smartPreFilter['ID'] = $productsIds;
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_URL_TEMPLATES" => array(
			"sections" => "popular/",
			"section" => "popular/#SECTION_CODE_PATH#/",
			"element" => "product/#ELEMENT_CODE#/",
			"compare" => "popular/compare/",
			"smart_filter" => "popular/#SECTION_CODE_PATH#/filter/#SMART_FILTER_PATH#/apply/",
		)
	),
	false
);
