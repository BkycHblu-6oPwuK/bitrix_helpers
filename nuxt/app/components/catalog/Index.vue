        ...
        <div v-else-if="sectionData" class="grid gap-8">
            <aside class="lg:col-span-1">
                <div class="sticky top-4">
                    <CatalogFilter v-if="sectionData.filter" :filter="sectionData.filter"
                        @apply-filter="handleApplyFilter" @clear-filter="handleClearFilter"
                        @update-sorting="handleUpdateSorting" />
                </div>
            </aside>

            <main class="lg:col-span-3">
                <CatalogSections v-if="sectionData.sectionList?.length" :sections="sectionData.sectionList"
                    class="mb-8" />
